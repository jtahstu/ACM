...
namespace 爬虫_HDUOJ_Accept.com.cn {
    class Program {
        static void Main(string[] args) {
            for (int t = 4600; t <= 5299; t++) {
                Console.WriteLine("正在处理hduoj第{0}题......", t);
                System.Net.WebClient client = new WebClient();
                string href = "http://accepted.com.cn/hdoj" + t.ToString() + "/";
                Stream strm;
                try {
                    ...
                    string link = "hduoj_" + t.ToString() + ".cpp";
                    StreamWriter sw2 = new StreamWriter(@"G:\ACM\OJ\code\hduoj_accept\" + link, true);
                    string zs = "//这是来自jtahstu的网络爬虫 at " + DateTime.Now + "\r\n//目前爬取的是hduoj第" + t.ToString() + "题\r\n";
                    show = zs + show;
                    sw2.WriteLine(show);
                    sw2.Close();
                } catch (Exception e) {
