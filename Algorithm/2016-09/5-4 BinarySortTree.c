...
//}
//BSTree *SearchBSTBST(BSTree *t,int key) {
//    if(!t || t->data==key) //结点为空，或关键字相等
//        return t;          //返回结点指针
//    else if(key>t->data) //关键字大于结点数据
//        return(SearchBSTBST(t->right,key));
//    else
//        return(SearchBSTBST(t->left,key));
//}
